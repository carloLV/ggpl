...
def create_school():
	building = CUBOID([11,9,4])
	diff = CUBOID([10,8,3])
	classRoom = DIFFERENCE([building,T([1,2,3])([.5,.5,.5])(diff)])
	furniture = w5.ggpl_create_furniture(10,8,3)
...
if __name__ == '__main__':
	...
	points = [[[60,0],[58,7.5],[60,15],[52,18],[46,21],[42,28],[40,32],[40,60],[40,80]],
	...
	st = STRUCT([le,table,q1,q2,fountain])
